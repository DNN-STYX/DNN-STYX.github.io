...
function mission(){
	...
	if [ "$i" -eq 1 ]; then
		...
		#==================================
		cd ../../
		cd mnist_MLP/mutation_training/
		...
		#==================================
		cd ../../
		cd mnist_CNN/mutation_training/
		...
		#==================================
		cd ../../
		cd fmnist_MLP/mutation_training/
		...
		#==================================
		cd ../../
		cd fmnist_CNN/mutation_training/
		...
		#==================================
		cd ../../
		cd cifar10_CNN/mutation_training/
